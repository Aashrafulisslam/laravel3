                      ...
                      <div class="login-separater text-center mb-4"> <span>OR SIGN UP WITH EMAIL</span>
                        ...
                        <div class="row g-3">
                          ...
                          <div class="col-12">
                            ...
                            <div class="ms-auto position-relative">
                              <div class="position-absolute top-50 translate-middle-y search-icon px-3"><i class="bi bi-lock-fill"></i></div>
                              <input type="password" name="password_confirmation" class="form-control radius-30 ps-5" id="password_confirmation" placeholder="Confirm Password">
                            </div>
                          </div>
                          </div>
                          ...
                          <div class="col-12">
                            <p class="my-2">Already have an account? <a href="{{ route('login') }}">Sign in here</a></p>
                          </div>
                        </div>
                    </form>
                 </div>
