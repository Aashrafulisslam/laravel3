                    ...
                    <div class="border p-4 rounded">
                        ...
                        <form action="{{ route('add_category') }}" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <button type="submit" class="btn btn-primary px-5" onclick="dataAdded(event)">Add Category</button>
                                </div>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="border p-4 rounded">
                        ...
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('edit_ctg',['id' => $category->id]) }}" class="btn btn-sm btn-primary">Edit</a>
                                    {{-- <a href="{{ route('delete'}}" class="btn btn-danger">Delete</a> --}}
                                    <form action="{{ route('delete_ctg') }}" method="post" style="display:inline-block">
                                        @csrf
